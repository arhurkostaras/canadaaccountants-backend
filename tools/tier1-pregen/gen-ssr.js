...
function buildPage(data, id) {
  ...
  let bioHtml, bioTitle = 'AI-Generated Professional Bio', bioSubtitle = 'Created from CPA directory data';
  if (p.bio) {
                ...
                <div class="profile-content">
                    <div class="section-card">
                        <div class="section-header">
                            ...
                            <div>
                                <div class="section-title">${bioTitle}</div>
                                <div class="section-subtitle">${bioSubtitle}</div>
                            </div>
                        </div>
                        ${bioHtml}
                    </div>
