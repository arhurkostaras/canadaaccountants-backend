...
// Gated = is_misclassified OR has_enrichment_collision OR is_generic_inbox, the same
// three flags /api/profiles/:id and /api/claim/profile/:refToken refuse with 410.
...
const INDEXABILITY_COLUMNS =
  ...
  'has_enrichment_collision, is_generic_inbox, firm_name, city, generated_bio, designation';
